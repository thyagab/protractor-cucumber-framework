...
module.exports = function () {
  ...
  browser.getProcessedConfig().then(function(currentConfig) {
    browserDetails=currentConfig.capabilities.browserName+'|'+currentConfig.capabilities.browser_version;
  });
  ...
  this.registerHandler('AfterScenario', function (event, callback) {
    ...
    stepResults.description = 'Scenarion Execution Details'+'|'+scenarioInfo.name+'|'+browserDetails;
    if (scenarioFailed) {
